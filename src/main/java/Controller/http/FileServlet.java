...
@WebServlet(name = "FileServlet", urlPatterns = "/dataset/*")
public class FileServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        this.basePath = System.getenv("CATALINA_HOME") + File.separator + "dataset";
    ...
    (HttpServletRequest request, HttpServletResponse response, boolean content)
        ...
        File file = new File(basePath, URLDecoder.decode(requestedFile, "UTF-8"));//StandardCharsets.UTF-8 eliminato come parametro e sostituito con UTF-8
